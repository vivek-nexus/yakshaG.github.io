    ...
    return (
        <>
            <a href={contentCardData[props.cardNumber - 1].link.linkURL} target="_blank" referrerPolicy="no-referrer" className="h-full">
                <div ref={ref} className={`flex flex-col justify-between ${props.bgColour == "primary" ? `bg-primary-100 hover:bg-primary-200` : `bg-secondary-50 hover:bg-secondary-100`} p-8 rounded-lg shadow hover:shadow-lg border-2 border-transparent transition duration-500 h-full ${inView && `animate__animated animate__zoomIn`} `}>
                    <div className="mb-8">
