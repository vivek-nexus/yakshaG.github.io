function Button(props) {
    if (props.type == "primary")
        ...
        return (
            <button className="px-4 py-2 bg-primary-50 text-primary-700 rounded-lg shadow-lg hover:shadow-2xl  flex items-center font-bold transition-all ease-in-out duration-300">
                {props.children}
            </button>
        )
}
